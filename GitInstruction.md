...
## 3. Присоединение к чужому проекту 
...
## 6. Отправка изменений с локального компьютера на GitHub
...
## 7. Pull request своих изменений владельцу проекта
...
## 8. Выкачивание актуальной версии проекта
