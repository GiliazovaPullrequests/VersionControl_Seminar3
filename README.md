...
*git clone <ссылка на удаленный репозиторий>* - клонирование репозитория

*git remote add <имя> <ссылка на удаленный репозиторий>* - добавление удаленного репозитория

*git pull <имя удаленного репозитория> <имя ветки>* - получение последних изменений с удаленного репозитория

*git push <имя удаленного репозитория> <имя ветки>* - отправка изменений на удаленный репозиторий

*git remote remove <имя удаленного репозитория>* - удаление удаленного репозитория