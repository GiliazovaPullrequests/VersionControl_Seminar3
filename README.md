...
*git checkout master(main) либо хэш-номер комита* - переход между изменениями либо возврат к текущему состоянию
...
*git merge имя_ветки* - слияние ветки которую присоединяем в текущую ветку 
