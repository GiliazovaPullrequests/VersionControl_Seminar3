...
*git log* - вывод истории комитов в хронологическом порядке, Если нужно кратко, то *git log --oneline*. Для отображения веток команда *git log --graph*
...
И еще можно добавить другие команды, которые узнаю в процессе обучения.