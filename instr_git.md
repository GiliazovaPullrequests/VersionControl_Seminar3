...
6. В папке создать файл, внести в него нужные изменения --> в терминале набрать стандартные команды: *add, commit -m*
7. В терминале набрать команду *git push
Если возникнет подсказка с нужной командой (указание ветки) скопировать ее и запустить в терминале
